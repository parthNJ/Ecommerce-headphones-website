...
<body>
    <nav class = "navbar navbar-inverse">
		    ...
		    <div>
		        <img src = "https://cdn.gearpatrol.com/wp-content/uploads/2017/10/Bose-Sound-Sport-Free-gear-patrol-1-1940x1300.jpg" 
		        class = "img-responsive " width=1380px;>
		        <h1 class = "headLogo">Bose</h1>
		        <h3 class = "headLogo_2">Headphone</h3>
		    </div>
		    <h1 style="text-align:center;" class = "top_prod">Bose top Products</h1>
