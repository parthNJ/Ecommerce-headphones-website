...
<body>
    <nav class = "navbar navbar-inverse">
		    ...
		    <div>
		        <img src = "http://mikuta.nu/wp-content/uploads/2016/11/mikuta-klemens-skullcandy-crusher-9.jpg" 
		        class = "img-responsive " width=1380px;>
		        <h1 class = "headLogo" style = "font-size:170px; color:black;">Skullcandy</h1>
		        <h3 class = "headLogo_2" style = "color:black;">Headphones</h3>
		    </div>
		    <h1 style="text-align:center;" class = "top_prod">Skullcandy top Products</h1>
