...
<body>
    <nav class = "navbar navbar-inverse">
		    ...
		    <div>
		        <img src = "https://shopswell-com-prod.s3.amazonaws.com/assets/dbd0e01d-bb6e-4e66-a86c-9e73ec179ca8/SonyPhones.jpg" 
		        class = "img-responsive " width=1380px;>
		        
		        <h3 class = "headLogo_2">Accessories</h3>
		    </div>
		    <h1 style="text-align:center;" class = "top_prod">Top notch accessories</h1>
