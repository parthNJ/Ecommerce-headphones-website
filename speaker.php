...
<body>
    <nav class = "navbar navbar-inverse">
		    ...
		    <div>
		        <img src = "http://data.1freewallpapers.com/download/collection-of-speakers.jpg" 
		        class = "img-responsive " width=1380px;>
		        <h1 class = "headLogo" style = "font-size:150px;">Speakers</h1>
		    </div>
		    <h1 style="text-align:center;" class = "top_prod">Top notch speakers</h1>
